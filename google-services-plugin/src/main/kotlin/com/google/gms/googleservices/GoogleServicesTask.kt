...
abstract class GoogleServicesTask : DefaultTask() {
  ...
  private fun handleWebClientId(clientObject: JsonObject, resValues: MutableMap<String, String?>) {
   ...
   */
  @Throws(IOException::class)
  private fun handleMapsService(clientObject: JsonObject, resValues: MutableMap<String, String?>) {
  ...
  private fun handleGoogleApiKey(clientObject: JsonObject, resValues: MutableMap<String, String?>) {
    val apiKey = getAndroidApiKey(clientObject)
    if (apiKey != null) {
  ...
  @Throws(IOException::class)
  private fun handleGoogleAppId(clientObject: JsonObject, resValues: MutableMap<String, String?>) {
    val clientInfo =
        clientObject.getAsJsonObject("client_info") ?: // Should not happen
